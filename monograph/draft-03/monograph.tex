...
\section{Dependencies}
Depends on SITH Theory (\Cref{sec:sith}).

\section{Integration Notes}
Integrates with Inforganic Codex (\Cref{sec:inforganic_codex}) and SITH Theory (\Cref{sec:sith}).
...
\section{Integration Notes}
Integrates with SITH Theory (\Cref{sec:sith}).
...
\section{Integration Notes}
Integrates with Inforganic Codex (\Cref{sec:inforganic_codex}).
...
\section{Dependencies}
Depends on Womb Body Bioforge (\Cref{sec:womb_bioforge}).

\section{Integration Notes}
Integrates with Womb Body Bioforge (\Cref{sec:womb_bioforge}).
